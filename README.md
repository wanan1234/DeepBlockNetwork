...
1.1双指双击-弹窗菜单：开启断网&关闭断网（无重启app提示）

1.2双指双击-弹窗菜单：开启联网&关闭联网（无重启app提示）

1.3双指长按-弹窗菜单：开启联网&关闭联网（有重启app提示）

1.4双指长按-弹窗菜单：开启联网&关闭联网（多看app专版。有重启app提示）

1.5双指双击-弹窗菜单：开启联网&关闭联网（有重启app提示）
## 编译
